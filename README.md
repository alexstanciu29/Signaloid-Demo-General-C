...
```html
[<img src="https://assets.signaloid.io/add-to-signaloid-cloud-logo-dark-v6.svg#gh-dark-mode-only" alt="[Add to signaloid.io]" height="30">](https://signaloid.io/repositories?connect=<"https://github.com/alexstanciu29/Signaloid-Demo-General-C#option-1--using-the-add-to-signaloidio-button">#gh-dark-mode-only)
[<img src="https://assets.signaloid.io/add-to-signaloid-cloud-logo-light-v6.svg#gh-light-mode-only" alt="[Add to signaloid.io]" height="30">](https://signaloid.io/repositories?connect=<"https://github.com/alexstanciu29/Signaloid-Demo-General-C#option-1--using-the-add-to-signaloidio-button">#gh-light-mode-only)
```
